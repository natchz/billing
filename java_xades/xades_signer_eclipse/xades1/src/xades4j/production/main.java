...
public class main {
    ...
    private static  String DOCUMENT = "C:/Users/german/PycharmProjects/billing/inv.xml";
	private static  String SIGNED = "C:/Users/german/PycharmProjects/billing/inv_signed.xml";
	private static final String FOLDER = "C:/Users/german/PycharmProjects/billing/java_xades/";
	private static final String POLICY = "C:/Users/german/PycharmProjects/billing/java_xades/politicadefirmav1.pdf";
...
private static void signEpes() throws Exception {
 ...
 // Role
    ...
    XadesSigner signer1 = (XadesSigner) new XadesEpesSigningProfile(kdp, policyInfoProvider)
            .withSignaturePropertiesProvider(new SignaturePropertiesProvider() {
                @Override
                public void provideProperties(SignaturePropertiesCollector arg0) {
                    SigningTimeProperty sigTime = new SigningTimeProperty();
   ...
   System.out.println("    ====> Agregando Transformation");

   TransformerFactory tFactory = TransformerFactory.newInstance();
   Transformer transformer = tFactory.newTransformer();
   System.out.println("    ====> Getting source doc");

   DOMSource source = new DOMSource(doc);
   System.out.println("    ====> Getting result stream doc");
